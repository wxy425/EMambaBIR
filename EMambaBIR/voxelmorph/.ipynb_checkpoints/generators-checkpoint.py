...
def volgen(
    ...
    if isinstance(vol_names, str):  #检查是否为字符串
    ...
    while True:
        ...
        indices = np.random.randint(len(vol_names), size=batch_size) #指定范围(len(vol_names))内，随机生成size个整数
